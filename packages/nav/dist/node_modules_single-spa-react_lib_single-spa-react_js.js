(window["webpackJsonpsearch"] = window["webpackJsonpsearch"] || []).push([["node_modules_single-spa-react_lib_single-spa-react_js"],{
...
!function (e, t) {
  ...
  function u(t, n) {
    var o = t.React.createElement(t.rootComponent, n),
        r = e.SingleSpaContext ? t.React.createElement(e.SingleSpaContext.Provider, {
      value: n
    }, o) : o;
    return t.errorBoundary && (t.errorBoundaryClass = t.errorBoundaryClass || function (e) {
      function t(n) {
    ...
    }(t), r = t.React.createElement(t.errorBoundaryClass, n, r)), r;
  }

  e.default = function (s) {
    if ("object" !== t(s)) throw new Error("single-spa-react requires a configuration object");
    ...
    if (!u.React) throw new Error("single-spa-react must be passed opts.React");
    if (!u.ReactDOM) throw new Error("single-spa-react must be passed opts.ReactDOM");
    if (!u.rootComponent && !u.loadRootComponent) throw new Error("single-spa-react must be passed opts.rootComponent or opts.loadRootComponent");
    if (u.errorBoundary && "function" != typeof u.errorBoundary) throw Error("The errorBoundary opt for single-spa-react must either be omitted or be a function that returns React elements");
    !e.SingleSpaContext && u.React.createContext && (e.SingleSpaContext = u.React.createContext());
    var l = {
      bootstrap: a.bind(null, u),
      mount: i.bind(null, u),
      unmount: c.bind(null, u)
    };
    return u.parcelCanUpdate && (l.update = p.bind(null, u)), l;
...
//# sourceMappingURL=node_modules_single-spa-react_lib_single-spa-react_js.js.map